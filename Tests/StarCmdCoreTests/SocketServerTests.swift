...
struct SocketServerTests {
    ...
    func receiveMessage() async throws {
        ...
        let json = """
        {"type":"register","session_id":"test123","tmux":"dev:editor:@2:%5","cwd":"/tmp","source":"startup","timestamp":1234567890}
        """
    ...
    func multipleConnections() async throws {
        ...
        for i in 0..<3 {
            let json = """
            {"type":"register","session_id":"test\(i)","tmux":"dev:editor:@\(i):%\(i)","cwd":"/tmp","source":"startup","timestamp":1234567890}
            """
